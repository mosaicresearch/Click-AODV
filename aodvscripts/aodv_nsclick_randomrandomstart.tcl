...
$ns_ use-newtrace
set tracefd	[open "aodv_nsclick_randomrandomstart.tr" w]
set namtrace    [open "aodv_nsclick_randomrandomstart.nam" w]
...
for {set i 0} {$i < $nodecount} {incr i} {
	...
	$node_($i) set speed_ 1
	$ns_ at [expr rand()] "[$node_($i) entry] loadclick \"aodv.click\"; [$node_($i) entry] runclick"
