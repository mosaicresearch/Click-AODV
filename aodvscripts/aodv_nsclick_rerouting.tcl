...
#
set tracefd	[open "aodv_nsclick_rerouting.tr" w]
set namtrace    [open "aodv_nsclick_rerouting.nam" w]
...
# move away node 3 and analyse reaction
$ns_ at  50	"$node_(3) set X_	400"
...
for {set i 0} {$i < $nodecount} {incr i} {
	...
	$ns_ at [expr rand()] "[$node_($i) entry] loadclick \"aodv_jittered.click\"; [$node_($i) entry] runclick"
}
